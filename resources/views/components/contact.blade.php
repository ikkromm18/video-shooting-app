<section id="kontak" class="bg-gray-100 dark:bg-gray-900">
    <div class="px-8 md:px-20 py-16 text-gray-700">
        ...
        <h1 class="font-bold text-4xl">Kontak</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 mt-4">
            ...
            <div class="p-4 md:p-8 h-10">

                <div class="bg-white p-5 rounded-sm shadow-sm">
                    <h1 class="text-center md:text-left">Tanggal Yang Sudah Dibooking</h1>
                    <div class="h-48 overflow-y-auto mt-3">
                ...
                <div class="bg-white p-5 rounded-sm shadow-sm mt-2">
                    <div class="">
