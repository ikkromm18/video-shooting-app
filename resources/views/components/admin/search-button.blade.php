@props(['placeholder' => 'Masukkan data', 'name' => 'search'])
...
<form class="flex items-center max-w-sm" method="GET">
    ...
    <div class="relative w-full">
        ...
        <input type="text" name="{{ $name }}" id="simple-search"
    ...
    <button type="submit"
        class="p-2.5 ms-2 text-sm font-medium text-white bg-[#2B5A9E] hover:bg-[#335077] rounded-lg border border-blue-700 ">
